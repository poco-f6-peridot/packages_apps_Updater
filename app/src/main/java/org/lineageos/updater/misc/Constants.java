...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.derp.build.version";
    public static final String PROP_DEVICE = "ro.derp.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.derp.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "derpfest.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "derp.updater.uri";
